...
export default class Comment extends PureComponent {
    ...
    // highlight-start
    // 注意将componentDidMount声明为async函数
    async componentDidMount() {
        ...
        this._valine = new Valine({
            ...
            appId: process.env.NEXT_PUBLIC_COMMENT_appId,
            appKey: process.env.NEXT_PUBLIC_COMMENT_appKey,
            meta: ['nick'],
            visitor: true,
            recordIP: true,
            placeholder: '来骚话快活啊[]~(￣▽￣)~*',
            // requiredFields:['nick'],
            serverURLs: 'https://ilaem7v2.api.lncldglobal.com',
            pageSize: 10,
            avatar: 'retro',
